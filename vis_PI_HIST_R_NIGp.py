# Visualization for parameter analysis & ablation study of PI-HIST (R) on datasets w/ identity ground-truth
...
if __name__ == '__main__':
    ...
    t = (r'PI-HIST (R) on %s,$\psi_{\rm{act}}$=%s,$\psi_{\rm{norm}}$=%s,Mod$\uparrow$(%%)'
    ...
    plt.tight_layout()
    plt.show()
    #plt.savefig('vis/PI-HIST(R)_NIGp_%s_act=%s_norm=%s.svg' % (data_name, act, norm),
    #            format='svg',
    #            bbox_inches='tight',
    #            transparent=False)
    plt.close()