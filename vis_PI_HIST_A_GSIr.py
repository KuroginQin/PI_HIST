# Visualization for PI-HIST (A)'s result of graph superfamily identification (GSI) on real graphs
...
if __name__ == '__main__':
    ...
    plt.title('PI-HIST (A)', fontsize=16, weight='bold', pad=15, loc='left')
    ...
    plt.tight_layout()
    plt.show()
    #plt.savefig('vis/PI-HIST(A)_GSIr_L=%d_eps=%.1f_act=%s_norm=%s.svg' % (RW_len, eps, act, norm),
    #            format='svg',
    #            bbox_inches='tight',
    #            transparent=False)
    plt.close()