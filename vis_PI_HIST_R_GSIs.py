# Visualization for PI-HIST (R)'s result of graph superfamily identification (GSI) on LFR synthetic graphs
...
if __name__ == '__main__':
    ...
    # ====================
    # Load node-wise emb of all ind runs
    ...
    plt.tight_layout()
    plt.show()
    #plt.savefig('vis/PI-HIST(R)_GSIs_L=%d_eps=%.1f_act=%s_norm=%s.svg' % (RW_len, eps, act, norm),
    #            format='svg',
    #            bbox_inches='tight',
    #            transparent=False)
    plt.close()
