...
# On datasets w/ large-scale node position ground-truth
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_name', type=str) # dblp, amazon
    ...
    # ==========
    NPC_eva(node_set, ide_emb, gnd, trn_ratio=tr_ratio, n_splits=10, random_state=rand_seed_gbl)
