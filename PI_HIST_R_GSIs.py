# Pre-compute PI-HIST (R) embedding for graph superfamily identification (GSI) on synthetic graphs
...
if __name__ == '__main__':
    ...
    # =====================
    # Pre-compute GNN support
    sup_list = [[] for _ in range(num_runs)]
    # ====================
