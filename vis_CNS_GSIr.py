# Visualization for common neighbor signature (CNS)'s result of graph superfamily identification (GSI) on real graphs
...
# ====================
SD_stat = [] # List of graph-level emb (i.e., avg emb)
for t in range(num_graphs):
    # ====================
    data_name = data_name_list[t]
    # ==========
    pkl_file = open('emb/struc_div_stat_%s.pickle' % (data_name), 'rb')
