# Visualization for the reduced embeddings of struc2vec on the Zachary's karate club network
...
pkl_file = open('emb/struc2vec_karate_d=%d_emb.pickle' % (emb_dim), 'rb')
...
for i in range(num_nodes):
    if (i+1) == 1 or (i+1) == 34:
        plt.scatter(ide_emb_vis[i, 0], ide_emb_vis[i, 1], s=100, color='white', linewidths=2.5,
...
# ====================
# Set figure title
plt.title('struc2vec (Identity Embedding)', fontsize=18, fontweight='bold')
