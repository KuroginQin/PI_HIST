# Visualization for evaluation results of node-level tasks on graphs w/ node position ground-truth
...
if __name__ == '__main__':
    ...
    if qlt_lbl == 'micro' or qlt_lbl == 'macro':
        plt.title('Node Position Classification \non ' + data_name_map[data_name], fontsize=14, fontweight='bold')
    elif qlt_lbl == 'cond':
        plt.title('Node Identity Clustering \non ' + data_name_map[data_name], fontsize=14, fontweight='bold')
